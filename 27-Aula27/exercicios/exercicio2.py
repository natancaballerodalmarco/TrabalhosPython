...
print(f'Existem {lista[0].count(10)} 10 na lista!')

print('\n', '='*150)

# 5) Há o número 20 dentro da lista[1]?
print(f'Existem {lista[1].count(20)} 20 na lista!')
...
soma = sum(lista[0])
for i in lista[1]:
    print(f'A multiplicação entre {soma} e {i} é {soma*i}')
...
print(div)
if lista[1].count(div) > 0:
    print('o resultado da divisão entre o maior número e o menor número está na lista 1')
if lista[0].count(div) > 0:
    print('o resultado da divisão entre o maior número e o menor número está na lista 0')
else:
    print('O resultado não está em nenhuma lista!!!!')
