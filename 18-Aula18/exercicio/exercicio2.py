...
print(f'\n8- {lista[0][1]}: 5 maços de {lista[2][5]}, 4 pés de {lista[2][0]} e {lista[2][1]}')

# print('9: imprima com f-string a seguinte sequência: legumes: 1kg de feijão, 2kg de gão de bico, 1.5 kg dde soja,'
#       '1 pacote de ervilha')
print(f'\n9- {lista[0][2]}: 1kg de {lista[3][0]}, 2kg de {lista[3][5]} e 1.5kg de {lista[3][6]}')
