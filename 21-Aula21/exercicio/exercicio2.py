...
lista = []
while len(lista) < 5:   #Foi oq eu pensei para o rpoblema, pois quando eu usava o range ele não dicava com 5 números em casos de erro.
    try:
...
print(f'A média dos números digitados é {n/5}')
