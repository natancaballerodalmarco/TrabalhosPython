...
def separar(lista):
    ...
    lista_separada.append(lista_mulheres)
    lista_separada.append(lista_homens)
    print(lista_separada[0])
    print(lista_separada[1])
    print(f"possuem {len(lista_separada[0])} cadastros na lista de mulheres")
    print(f"possuem {len(lista_separada[1])} cadastros na lista de homens")
