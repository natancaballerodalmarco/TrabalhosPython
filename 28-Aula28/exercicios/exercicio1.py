...
class Pessoa:
    ...
    def tratar(self):
        pessoa = self.dadobruto.strip().split(';')
    ...
    def dicionario(self):
        dic = {'codigo':self.codigo, 'nome':self.nome, 'idade':self.idade, 'sexo':self.sexo, 'email':self.email, 'telefone':self.telefone}
        return(dic)
